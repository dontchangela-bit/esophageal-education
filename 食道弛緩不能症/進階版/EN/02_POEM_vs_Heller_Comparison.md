---
title: Esophageal Achalasia — POEM vs Heller Myotomy Comparison
version: 1.0
date: 2026-03-31
audience: advanced
lang: en
...
![POEM vs Heller Myotomy — Surgical Approach Comparison](../images/poem_vs_heller_approach.png)
...
```mermaid
flowchart TD
    A[Confirmed achalasia<br/>Subtype identified] --> B{Suitable for surgery/<br/>endoscopic treatment?}

    B -- No --> C[BTX injection /<br/>Medical therapy]
    B -- Yes --> D{Subtype?}
    ...
    E --> G{Patient factors}
    G --> G1[Concerned about GERD<br/>→ LHM + Fundoplication]
    G --> G2[Prefers no incision<br/>→ POEM]
    G --> G3[Prefers non-surgical<br/>→ Graded PD]

    F --> H[POEM preferred<br/>SAGES 2024 recommendation]

    G1 --> I[Shared decision-making<br/>with the patient]
    G2 --> I
    G3 --> I
    H --> I
