...
<!-- 📷 圖片佔位 -->
> **🖼️ 請插入圖片：**
> - 建議圖片：三種亞型的 HRM Clouse Plot 比較圖 (Type I, II, III)
> - 檔案放置：`../images/achalasia_subtypes_hrm.png`
> - 來源：院內檢查報告或醫學文獻授權圖（需標註出處）

![弛緩不能症三型 HRM 比較](../images/achalasia_subtypes_hrm.png)
<!-- 圖片佔位結束 -->
...
| 疾病 | 與弛緩不能症的鑑別要點 |
|------|----------------------|
| 假性弛緩不能症（Pseudoachalasia） | 由腫瘤（尤其是 EGJ 腺癌）引起；病程短、年齡大、體重減輕明顯；CT/EUS 可見腫塊 |
