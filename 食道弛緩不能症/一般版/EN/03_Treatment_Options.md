---
title: Esophageal Achalasia — Treatment Options
version: 1.0
date: 2026-03-31
audience: general
lang: en
...
![POEM Endoscopic View](../images/poem_endoscopic_view.png)
...
```mermaid
flowchart TD
    A[Confirmed diagnosis<br/>of esophageal achalasia] --> B{Is the patient suitable<br/>for surgery or<br/>endoscopic treatment?}

    B -- Yes --> C{Disease subtype?}
    B -- No --> D[Consider BTX injection<br/>or medical therapy]

    C --> E[Type I / Type II]
    C --> F[Type III — Spastic]

    E --> G{Patient preference?}
    G --> G1[Prefers no incision<br/>→ POEM]
    G --> G2[Prefers lower reflux risk<br/>→ Heller + Fundoplication]
    G --> G3[Prefers to avoid surgery<br/>→ Pneumatic Dilation]

    F --> H[POEM recommended as<br/>first-line — adjustable<br/>myotomy length]

    G1 --> I[Discuss in detail with<br/>your doctor to finalize<br/>the treatment plan]
    G2 --> I
    G3 --> I
    H --> I
