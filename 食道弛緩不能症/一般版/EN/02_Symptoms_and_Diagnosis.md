---
title: Esophageal Achalasia — Symptoms and Diagnosis
version: 1.0
date: 2026-03-31
audience: general
lang: en
...
![Barium Swallow — Bird-beak Appearance](../images/barium_bird_beak.png)
...
![HRM Clouse Plot — Achalasia](../images/hrm_achalasia_clouse_plot.png)
<!-- End of image placeholder -->
...
```mermaid
flowchart TD
    A[Onset of symptoms<br/>Dysphagia, regurgitation, weight loss] --> B{Persisting for<br/>more than 2 weeks?}
    B -- Yes --> C[See a doctor:<br/>Gastroenterology]
    B -- No --> B2[Observe; seek care<br/>if symptoms persist]
    B2 --> C

    C --> D[Initial evaluation<br/>Medical history + physical exam]
    D --> E[Upper endoscopy<br/>Rule out cancer and<br/>other conditions]

    E --> F{Did the endoscopy<br/>reveal another<br/>definitive cause?}
    F -- Yes --> G[Treat that specific condition]
    F -- No --> H[Barium swallow<br/>Evaluate esophageal shape<br/>and emptying]

    H --> I{Classic bird-beak<br/>sign present?}
    I -- Yes --> J[High-resolution manometry<br/>Confirm diagnosis + subtype]
    I -- Uncertain --> J

    J --> K{Meets diagnostic<br/>criteria for achalasia?}
    K -- Yes --> L[Confirmed diagnosis<br/>of esophageal achalasia<br/>with subtype classification]
    K -- No --> M[Consider other esophageal<br/>motility disorders]

    L --> N[Develop treatment plan]
