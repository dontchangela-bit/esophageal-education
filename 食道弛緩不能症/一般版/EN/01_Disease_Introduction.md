---
title: Esophageal Achalasia — Disease Introduction
version: 1.0
date: 2026-03-31
audience: general
lang: en
...
![Normal Esophagus vs. Achalasia — Anatomical Diagram](../images/esophagus_achalasia_anatomy.svg)
...
```mermaid
graph TD
    subgraph Normal Swallowing
        A1[Food enters the mouth] --> B1[Esophageal peristalsis<br/>pushes food downward]
        B1 --> C1[LES relaxes<br/>and opens normally]
        C1 --> D1[Food passes smoothly<br/>into the stomach]
    end
